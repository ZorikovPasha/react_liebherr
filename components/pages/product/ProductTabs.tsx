            ...
            <div className="tabs__content-item tabs__content-item--shown item-content">
              ...
              <div className="item-content__images">
                <div className="item-content__img">
                  <Image src="/static/images/depict-1.jpg" alt="" width="100%" height="100%" objectFit="cover" layout="fill" />
                </div>
                <div className="item-content__img">
                  <Image src="/static/images/depict-2.jpg" alt="" width="100%" height="100%" objectFit="cover" layout="fill" />
                </div>
                <div className="item-content__img">
                  <Image src="/static/images/depict-3.jpg" alt="" width="100%" height="100%" objectFit="cover" layout="fill" />
                </div>
              </div>
            </div>
          )}
              ...
              <div className="item-specs__box flex jcsb">
                <div className="item-specs__item">
                  <div className="item-specs__images">
                    <Image className="guarantee__item-img" src="/static/images/specifications/1.jpg" alt="Спецификация" width="100%" height="100%" layout="fill" />
                  </div>
                ...
                <div className="item-specs__item">
                  <div className="item-specs__images">
                    <Image src="/static/images/specifications/1.jpg" alt="Спецификация" width="100%" height="100%" layout="fill" />
                  </div>
                  <a className="item-specs__link" href="#">
                    скачать
                  </a>
