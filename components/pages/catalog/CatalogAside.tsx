...
const CatalogAside = React.forwardRef<HTMLDivElement, AsidePropsType>(
  ({ query, onOpen }, AsideRef) => {
    ...
    const [liftingCapacityFrom, setLiftingCapacityFrom] = React.useState(
      initialValues.liftingCapacityFrom,
    )
    const [liftingCapacityTo, setLiftingCapacityTo] = React.useState(
      initialValues.liftingCapacityTo,
    )
    ...
    const [arrowLengthFrom, setArrowLengthFrom] = React.useState(
      initialValues.arrowLengthFrom,
    )
    const [arrowLengthTo, setArrowLengthTo] = React.useState(
      initialValues.arrowLengthTo,
    )
    ...
    const onTypeToggle = (
      value: boolean,
      setStateCb: React.Dispatch<React.SetStateAction<boolean>>,
    ) => {
      setStateCb(!value)
    }
    ...
    return (
      <aside
        className={`catalog-content__aside aside-catalog ${
          isAsideOpened ? 'opened' : ''
        }`}
      >
        <div
          className={`aside-catalog__body rel ${
            isAsideBodyOpened ? 'opened' : ''
          }`}
          ref={AsideRef}
        >
            ...
            <form className="aside-catalog__form" onSubmit={handleSubmit}>
              <div className="aside-catalog__filter aside-filter">
                ...
                <label className="flex aic">
                  ...
                  />
                  <span className="aside-filter__check-fake rel" />
                  <span className="aside-filter__text">
                    Модульные платформы
                  </span>
                </label>
              </div>
              <div className="aside-catalog__filter aside-filter filter-weight">
                ...
                <div className="aside-filter__line flex aic">
                  <div className="aside-filter__input-box flex aic">
                    ...
                    <input
                      ...
                      onChange={onChangeRangeInput.bind(
                        null,
                        setLiftingCapacityFrom,
                      )}
                    />
                  </div>
                  <div className="aside-filter__input-box flex aic">
                ...
                <Range
                  ...
                  onChange={handleChangeRange.bind(
                    null,
                    setLiftingCapacityFrom,
                    setLiftingCapacityTo,
                  )}
