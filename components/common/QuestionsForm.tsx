            ...
            <form className="questions__form" onSubmit={handleSubmit}>
              <div className="questions__form-block">
                ...
                <input
                  ...
                  className={`questions__form-input ${
                    showErrors && !name.isValid ? 'form-input--error' : ''
                  } `}
                  type="text"
                  placeholder="Ваше имя"
                  value={name.value}
                  onChange={onChange}
                />
                {showErrors && !name.isValid && (
                  <p className="questions__form-message">{name.errorMessage}</p>
                )}
              </div>
              ...
              <div className="questions__form-block">
                ...
                <InputMask
                  ...
                  maskChar="_"
                  className={`questions__form-input ${
                    showErrors && !phone.isValid ? 'form-input--error' : ''
                  } `}
                  type={phone.type}
                ...
                {showErrors && !phone.isValid && (
                  <p className="questions__form-message">
                    {phone.errorMessage}
                  </p>
                )}
              </div>
              <div className="questions__form-block">
                ...
                <input
                  name="email"
                  className={`questions__form-input ${
                    showErrors && !email.isValid ? 'form-input--error' : ''
                  } `}
                  type="text"
                  placeholder="Ваша почта"
                  value={email.value}
              ...
              <div className="questions__form-block">
                ...
                <textarea
                  name="message"
                  className={`questions__form-textarea ${
                    showErrors && !message.isValid ? 'form-input--error' : ''
                  } `}
                  placeholder="Оставьте ваш вопрос"
                  value={message.value}
                  onChange={onChange}
                />
                {showErrors && !message.isValid && (
                  <p className="questions__form-message">
              ...
              >
                ...
                />
                <span
                  className={`questions__form-fake ${
                    showErrors && !state.isAgree ? 'form-input--error' : ''
                  }`}
                />
                <span className="questions__form-agree">
                  Я согласен с <a href="#">условиями обработки</a> и
