          ...
          <div className="questions__inner rel">
            ...
            <form className="questions__form" onSubmit={handleSubmit}>
              <div className="questions__form-block">
                ...
                <input name="name" className={`questions__form-input ${showErrors && !name.isValid ? 'form-input--error' : ''} `} type="text" placeholder="Ваше имя" value={name.value} onChange={onChange} />
              ...
              <div className="questions__form-block">
                ...
                <input name="email" className={`questions__form-input ${showErrors && !email.isValid ? 'form-input--error' : ''} `} type="text" placeholder="Ваша почта" value={email.value} onChange={onChange} />
              ...
              <div className="questions__form-block">
                ...
                <textarea name="message" className={`questions__form-textarea ${showErrors && !message.isValid ? 'form-input--error' : ''} `} placeholder="Оставьте ваш вопрос" value={message.value} onChange={onChange} />
              ...
              <label className="questions__form-label flex" htmlFor="questions-form-agree">
                <input id="questions-form-agree" name="isAgree" className="questions__form-real" type="checkbox" checked={state.isAgree} onChange={onAgree} />
