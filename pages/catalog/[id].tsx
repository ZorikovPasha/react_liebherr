      ...
      <section className="product-text block-text">
        <div className="container">
          ...
          <p className="block-text__text">
            ...
            этого подъемного крана к строительной площадке.
          </p>
          <p className="block-text__text">
            Этот 750-тонный кран может также использоваться с выдвижными
            опорами, имеющими опорную базу 13 x 13 м. Результирующая
...
export const getServerSideProps: GetServerSideProps = async ({ query }) => {
  const { machinery, similarOnes } = await publicApi.getSingleMachinery(
    Number(query.id),
  )
